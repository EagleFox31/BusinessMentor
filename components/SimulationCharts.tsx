...
const SimulationCharts: React.FC<SimulationChartsProps> = ({ user }) => {
  ...
  const handleSimulate = async () => {
    ...
    try {
      ...
      // Convert month numbers to "M{x}" format for display if needed
      ...
      <div className="glass-panel p-6 rounded-2xl border border-white/5 shadow-2xl">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <input
            ...
            placeholder={`Décrivez votre stratégie en ${user.country} (ex: 'Investissement marketing massif')`}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="glass-panel p-6 rounded-2xl">
          <div className="flex justify-between items-center mb-6">
              <h3 className="text-lg font-semibold text-slate-200">Flux de Trésorerie ({currency})</h3>
